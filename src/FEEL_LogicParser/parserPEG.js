...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    peg$c0 = function (program) {
      return { llqR: 'ProgramNode', p1: extractOptional(program, 0), p2: location() }// new ast.ProgramNode(extractOptional(program,0),location());
    },
    peg$c1 = "(",
    ...
    peg$c8 = function (head, tail) {
      return { llqR: 'SimpleExpressionsNode', p1: buildList(head, tail, 3), p2: location() } //new ast.SimpleExpressionsNode(buildList(head,tail,3), location());
    },
    peg$c9 = function (head, tail) {
      return { llqR: 'SimplePositiveUnaryTestNode', p1: extractOptional(head, 0), p2: tail, p3: location() }; //new ast.SimplePositiveUnaryTestNode(extractOptional(head,0),tail,location());
    },
    peg$c10 = "<=",
    ...
    peg$c20 = function (start, first, second, end) {
      return { llqR: 'IntervalNode', p1: start, p2: first, p3: second, p4: end, p5: location() } //new ast.IntervalNode(start,first,second,end,location());
    },
    peg$c21 = function () {
      return { llqR: 'IntervalStartLiteralNode', p1: "<", p2: location() } // new ast.IntervalStartLiteralNode("<",location());
    },
    peg$c22 = function () {
      return { llqR: 'IntervalStartLiteralNode', p1: "<=", p2: location() } // new ast.IntervalStartLiteralNode("<=",location());
    },
    peg$c23 = function () {
      return { llqR: 'IntervalEndLiteralNode', p1: ">", p2: location() } // new ast.IntervalEndLiteralNode(">",location());
    },
    peg$c24 = function () {
      return { llqR: 'IntervalEndLiteralNode', p1: ">=", p2: location() } // new ast.IntervalEndLiteralNode(">=",location());
    },
    ...
    peg$c30 = function (expr) {
      return { llqR: 'SimpleUnaryTestsNode', p1: expr, p2: null, p3: location() } //return new ast.SimpleUnaryTestsNode(expr,null,location());
    },
    peg$c31 = function (not, expr) {
      return { llqR: 'SimpleUnaryTestsNode', p1: expr, p2: not, p3: location() } // new ast.SimpleUnaryTestsNode(expr,not,location());
    },
    peg$c32 = "-",
    peg$c33 = peg$literalExpectation("-", false),
    peg$c34 = function () {
      return { llqR: 'SimpleUnaryTestsNode', p1: null, p2: null, p3: location() } // new ast.SimpleUnaryTestsNode(null,null,location());
    },
    peg$c35 = "not",
    ...
    peg$c39 = function (head, tail) {
      return { llqR: 'QualifiedNameNode', p1: buildList(head, tail, 3), p2: location() } // new ast.QualifiedNameNode(buildList(head,tail,3),location());
    },
    peg$c40 = "+",
    peg$c41 = peg$literalExpectation("+", false),
    peg$c42 = function (head, tail) {
      return { llqR: 'ArithmeticExpressionNode', p1: '+', p2: head, p3: tail[3], p4: location() } // new ast.ArithmeticExpressionNode('+', head, tail[3], location()); 
    },
    ...
    peg$c53 = function (expr) {
      return { llqR: 'ArithmeticExpressionNode', p1: '-', p2: null, p3: expr[1], p4: location() } // new ast.ArithmeticExpressionNode('-', null, expr[1], location());
    },
    peg$c54 = function (head, tail) {
      return { llqR: 'NameNode', p1: buildName(head, tail, 0), p2: location() }// new ast.NameNode(buildName(head,tail,0),location());
    },
    ...
    peg$c73 = function (chars) {
      return { llqR: 'LiteralNode', p1: chars.join(""), p2: location() } // new ast.LiteralNode(chars.join(""),location());
    },
    peg$c74 = "'",
    ...
    peg$c114 = function () {
      return { llqR: 'LiteralNode', p1: true, p2: location() } // new ast.LiteralNode(true, location());
    },
    peg$c115 = function () {
      return { llqR: 'LiteralNode', p1: false, p2: location() } // new ast.LiteralNode(false, location());
    },
    peg$c116 = "true",
    ...
    peg$c128 = function (negative, number) {
      return { llqR: 'LiteralNode', p1: Number((negative || "") + number), p2: location() } //new ast.LiteralNode(Number((negative || "") + number),location());
    },
    ...
    peg$c134 = function (symbol, head, tail) {
      return { llqR: 'DateTimeLiteralNode', p1: symbol[0], p2: buildList(head, tail, 3), p3: location() }// new ast.DateTimeLiteralNode(symbol[0], buildList(head, tail, 3), location());
    },
    ...
    peg$c148 = function (fnName, params) {
      return { llqR: 'FunctionInvocationNode', p1: fnName, p2: extractOptional(params, 1), p3: location() }// new ast.FunctionInvocationNode(fnName,extractOptional(params,1),location());
    },
    peg$c149 = function (head, tail) {
      return { llqR: 'PositionalParametersNode', p1: buildList(head, tail, 3), p2: location() }// new ast.PositionalParametersNode(buildList(head,tail,3),location());
    },
    peg$c150 = function () { 
      return { llqR: 'LiteralNode', p1: null, p2: location() } //new ast.LiteralNode(null, location());
    },
    peg$c151 = "null",
  ...
  function location() {
    return null//peg$computeLocation(peg$savedPos, peg$currPos);
  }
  ...
  function buildComparisonExpression(head, tail, loc) {
    return tail.reduce((result, element) => {
      ...
      return { llqR: 'ComparisonExpressionNode', p1: operator, p2: result, p3: element[3], p4: null, p5: location() }// new ast.ComparisonExpressionNode(operator, result, element[3], null, loc);
    }, head);
  }
